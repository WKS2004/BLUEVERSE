...
Apply this to `apps/mobile` only after inspecting the existing navigation
setup. Route guards may improve UX, but backend permissions remain
authoritative. Do not expose internal Auth or Agentic AI routes; use the public
API/gateway convention and preserve platform-specific responsibilities.
