...
|---|---|
| Select context | Choose or navigate from a destination/activity and request a relevant location and period. Invalid or incomplete inputs receive actionable feedback. |
