...
limits, storage provider and retention policy must be decided before Member 4
implements uploads.
...
Member 4's v1 operational assessment already presents evidence to an
...
1. Member 4 owns optional image evidence attached to its operational
...
- The feature supports Member 4's human evidence-review task; it does not give
...
- [Member 4 Safety & Operations Agent contract](../v1/agents/member-4-safety-operations-agent.md)
